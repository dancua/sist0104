...
public class Format_01 {
	...
	public static void main(String[] args) {
		...
		//NumberFormat 숫자를 문자열로 변환하여 출력(컴마,소수점자리 지정)
		
		int money = 12345678;
		double num = 98.1234;
		
		NumberFormat nf1 = NumberFormat.getCurrencyInstance(); //화폐단위,콤마 제공
		System.out.println(nf1.format(money));
		
		NumberFormat nf2 = NumberFormat.getInstance(); // 화폐단위 X 콤마만 제공
