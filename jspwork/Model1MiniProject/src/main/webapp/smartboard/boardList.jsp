...
<caption align="top">스마트게시판 목록</caption>
<tr>
<th width="80">번호</th>
<th width="380">제목</th>
<th width="150">작성자</th>
...
<%}else{
	...
	<span style="text-overflow: ellipsis; white-space:nowrap; overflow:hidden; width:250px; display:block;"><%=dto.getSubject() %></span></a>
