		...
		<input type="hidden" name="num" value="<%=num %>">
			<table class="table table-bordered">
				...
				<tr>
					...
					class="form-control" style="width: 80px;" onkeyup="goFocus(this)"
					value="<%=hp2%>">
					<b>-</b>
					<input type="text" name="hp3" required="required"
					class="form-control" style="width: 80px;" value="<%=hp3%>"></td>
				</tr>

				<tr>
					<th width="100" class="table-info">생년월일</th>
					<td><input type="date" name="birth" required="required"
						class="form-control" style="width: 150px;" value=<%=dto.getBirth()%>>
					</td>
				</tr>
				<tr>
					<td colspan="2" align="center"><input type="submit"
						value="db수정" class="btn btn-outline-info"> <input
						type="button" value="목록" class="btn btn-outline-warning"
