...
$(function(){
	...
	$("#btninsert").click(function(){
		...
		console.log({writer,subject,story,image});
		
		$.ajax({
			type:"post",
			dataType:"html",
			url:"insertWrite.jsp",
			data:{writer,subject,story,image},
			success:function(){
  ...
  <div class="board updateform" style=" width: 400px;">
     <form id="updatefrm">
       <table class="table table-bordered">
         ...
         <tr>
           <th width="100" class="table-warning">새 작성자</th>
           <td>
         ...
         <tr>
           <th width="100" class="table-warning">새 제목</th>
           <td>
         ...
         <tr>
           <th width="100" class="table-warning">새 내용</th>
           <td>
             <textarea style="width: 300px; height: 100px;"
             name="ustory" id="ustory" 
             class="form-control"></textarea>
           </td>
         </tr>
         
         <tr>
           <th width="100" class="table-warning">새 이미지</th>
           <td>
