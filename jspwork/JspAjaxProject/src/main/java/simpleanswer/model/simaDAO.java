...
public class simaDAO {

	DbConnect db = new DbConnect();
	
	public void insertAnswer(simaDTO dto)
	{
	...
	public List<simaDTO> getAllDatas(String num){
		
		ArrayList<simaDTO> list = new ArrayList<simaDTO>();
